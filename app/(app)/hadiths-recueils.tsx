/**
 * Parcours des recueils — 4 recueils, navigables par thème puis par chapitre.
 *
 * Cet écran était auparavant l'écran Hadiths lui-même. Depuis que l'onglet
 * ouvre directement sur le flux de lecture (app/(app)/hadiths.tsx), il est
 * accessible par l'icône « recueils » en coin du flux. Il reste complet :
 * c'est la porte d'entrée pour qui cherche un hadith précis plutôt que de
 * se laisser porter.
 *
...
export default function HadithsRecueilsScreen() {
    ...
    <View style={[styles.screen, { backgroundColor: T.pageBg }]}>
      ...
      >
        ...
        <Text style={styles.headerTitle}>
          {chapterId != null ? chapterLabel(chapterId) : tr('hadiths.recueils.headerTitle')}
        </Text>
        <View style={styles.headerRule} />
        <Text style={styles.headerSub}>
          {chapterId != null
            ? tr('hadiths.countInChapter', { n: chapterHadiths.length })
            : tr('hadiths.recueils.headerSub')}
        </Text>
      </LinearGradient>
