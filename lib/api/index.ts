...
export { fetchSections, fetchLesson, fetchVersets, fetchAllSourates } from './content';
export type { SourateVersets, Verset, VersetMot, SourateListItem, SourateSummary } from './content';
