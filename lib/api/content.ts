...
export interface SourateListItem {
  ...
  /** Présents uniquement sur GET /me/sourates (pas sur GET /sourates) : couleur
   *  de la section qui enseigne cette sourate — pour assortir le badge à sa
   *  section plutôt qu'une couleur fixe. */
  couleur?: string | null;
